...
***/
	...
	public static void modifyCustomer(){
		...
		String name, Address, phoneNumber, enrollingDate;
	...
	public static void addDvdCd(){		
		...
		Scanner input = new Scanner(System.in);
		String Title, Company, Release_Date, Borrowed_Date, DVD;
	...
	public static void rentalDvdCd(){
		...
		for(int i = 0; i < 500; i++){
				if(customer_record[i][4].equals() != null)
	...
	public static void returnDvdCd(){
		...
		Scanner input = new Scanner(System.in);
		String name;
		int Borrowed, Overdue, Rental Fee;
